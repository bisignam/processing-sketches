  ...
  if(!step){
      ...
      if(cropHeight % squareHeight != 0) {
         throw new RuntimeException(
           "The squareHeight parameter with value "
            +squareHeight+ " should be a divisor of cropHeight with value "
            +cropHeight);
      }
  
      if(cropWidth % squareWidth != 0) {
         throw new RuntimeException("The squareWidth parameter with value "
              +squareWidth+" should be a divisor of cropWidth with value "
              +cropWidth);
      }
